RSpec.describe Entities::Console do
  ...
  #   let(:input) { %w[load exit]}
  #
  #   it 'load' do
  #
  #     expect { console }.to output(/#{ASK_PHRASES[:login]}/).to_stdout
  #   end
  # end
  #
  ...
  #   let(:input) { %w[exit]}
  #   it do
  #     expect { console }.to output(/#{HELLO_PHRASE}/).to_stdout
  #   end
  # end
  ...
  #   let(:input) { [success_name_input, success_age_input, success_login_input, success_password_input] }
  #
  ...
  #       current_subject.instance_variable_set(:@accounts, [])
  #     end
  #
  #     after do
  ...
  #   end
    ...
    #       let(:test_account) { instance_double('Account', login: error_input, errors: []) }
    #
    #
    #       before do
    #         allow(current_subject).to receive(:load_accounts).and_return([test_account])
    #         current_subject.instance_variable_set(:@accounts, [test_account])
    #       end
    #
    #       it { expect { current_subject.create_account }.to output(/#{error}/).to_stdout }
    #     end
  ...
  #     let(:test_account) { instance_double('Account', login: login, password: password, errors: []) }
  #
  #     before do
  #       allow(current_subject).to receive_message_chain(:gets, :chomp).and_return(*all_inputs)
  #       allow(current_subject).to receive(:load_accounts) { [test_account] }
  #       current_subject.instance_variable_set(:@accounts, [test_account])
  #     end
  #
  #     context 'with correct outout' do
  ...
  #   let(:correct_account) { instance_double('Account', login: correct_login, errors: []) }
  #   let(:fake_account) { instance_double('Account', login: fake_login, errors: []) }
  #   let(:fake_account2) { instance_double('Account', login: fake_login2, errors: []) }
  ...
  #   let(:correct_account) { Entities::Account.new(name: correct_name, age: correct_age, login: correct_login, password: correct_password, accounts: []) }
  #
  #   context 'with correct outout' do
  #     it do
  ...
  #       current_subject.instance_variable_set(:@accounts, [correct_account])
  #       allow(File).to receive(:open)
  ...
  #   end
  #
  #   context 'when cor rect card choose' do
  #     before do
  #       current_subject.instance_variable_set(:@accounts, [correct_account])
  #       current_subject.instance_variable_set(:@file_path, OVERRIDABLE_FILENAME)
  #       current_subject.instance_variable_set(:@current_account, correct_account)
  ...
  #   let(:correct_login) { 'test' }
  #   let(:correct_password) { '123456' }
  #   # let(:correct_account) { instance_double('Account', card: []) }
  #   let(:correct_account) { Entities::Account.new(name: correct_name, age: correct_age, login: correct_login, password: correct_password, accounts: []) }
  #
  ...
  #     let(:card_one) { instance_double('Card', number: 1, type: 'test') }
  #     let(:card_two) { instance_double('Card', number: 1, type: 'test2') }
  #     let(:fake_cards) { [card_one, card_two] }
  #     let(:correct_account) { instance_double('Account', card: fake_cards) }
  #
  #     context 'with correct outout' do
  #       it do
  #         current_subject.instance_variable_set(:@current_account, correct_account)
  ...
  #       let(:correct_account) { Entities::Account.new(name: correct_name, age: correct_age, login: correct_login, password: correct_password, accounts: []) }
  #       let(:deletable_card) { instance_double('Card', number: deletable_card_number, type: 'test') }
  #
  #       before do
  #         correct_account.instance_variable_set(:@card, [deletable_card])
  #         current_subject.instance_variable_set(:@file_path, OVERRIDABLE_FILENAME)
  #         current_subject.instance_variable_set(:@accounts, [correct_account])
  #         allow(current_subject).to receive(:load_accounts) { [correct_account] }
  #         current_subject.instance_variable_set(:@current_account, correct_account)
  #       end
  #
  #       after do
  ...
  #
  #   before do
  #     correct_account.instance_variable_set(:@card, [])
  #   end
  #
  #   context 'without cards' do
  #     it 'shows message about not active cards' do
  ...
  #
  #     before do
  #       correct_account.instance_variable_set(:@card, fake_cards)
  #       current_subject.instance_variable_set(:@accounts, [correct_account])
  #       current_subject.instance_variable_set(:@current_account, correct_account)
  #     end
  #
  ...
  #
  #     context 'with correct input of card number' do
  #       let(:card_one) { instance_double('Card', number: 1, type: 'capitalist', balance: 50.0) }
  #       let(:card_two) { instance_double('Card', number: 2, type: 'capitalist', balance: 100.0) }
  #       let(:fake_cards) { [card_one, card_two] }
  ...
  #           let(:custom_cards) do
  #             [
  #                 Entities::Card.new(type: 'usual', balance: default_balance, tax: correct_money_amount_greater_than_tax * 0.02, number: 1),
  #                 Entities::Card.new(type: 'capitalist', balance: default_balance, tax: 10, number: 1),
  #                 Entities::Card.new(type: 'virtual', balance: default_balance, tax: 1, number: 1),
  ...
  #               allow(current_subject).to receive_message_chain(:gets, :chomp).and_return(*commands)
  #               correct_account.instance_variable_set(:@card, [custom_card, card_one, card_two])
  #               current_subject.instance_variable_set(:@accounts, [correct_account])
  #               current_subject.instance_variable_set(:@current_account, correct_account)
  #               current_subject.instance_variable_set(:@file_path, OVERRIDABLE_FILENAME)
